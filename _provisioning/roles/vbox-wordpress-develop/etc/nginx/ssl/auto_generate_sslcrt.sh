...
organization_name="Dummy Company"
organization_unit="Dummy Division"
common_name="*.${domain}"
email="root@server"
...
Detail:
  ...
  if [ example.com ] is specified as your domain,
  the certificate is generated for wildcard domain [ *.example.com ].
